...
def test(config):
    ...
    f_in = open(config.inputFile, 'r', encoding='utf-8')
...
def argLoader():
    ...
    parser.add_argument('--save_path', type=str, default='/content/drive/MyDrive/LuanVan/model')
    # Actions
    ...
    parser.add_argument('--n_vocab', type=int, default=119547)
